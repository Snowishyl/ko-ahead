    ...
    private fun forward(modelWeight: ModelWeight, state: RunState, token: Int, pos: Int): FloatArray {
        ...
        for (l in 0 until p.nLayers) {
            ...
            for (i in 0 until hiddenDim) {
                ...
                value *= 1.0f / (1.0f + kotlin.math.exp(-value.toDouble()).toFloat())
                value *= state.hb2[i]
                state.hb[i] = value
            }
